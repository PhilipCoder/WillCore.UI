...
* */
    this.model= null;
/**
* Binds a HTML element iterator.
* */
    this.repeat= null;
/**
* Binds a partial view to an element.
* */
    this.view= null;
};
...
//</html>
   //<collections>
    this.userDetailCollection = { email: "", password: "", termsAndConditions: false };
    this.status = { countDown: configuration.countDownSeconds };
//</collections>
};
