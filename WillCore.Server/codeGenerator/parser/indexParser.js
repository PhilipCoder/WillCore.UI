...
class indexParser {
    ...
    processIndexFile() {
        return new Promise(async (resolve, reject) => {
            try {
                let js = await this.loadJS(this.filePath);
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                resolve({ views: views, components: components, layouts: layouts });
                            } catch (e) {
                                resolve({ message: LAYOUT_ERROR, error:e });
                            }
                        } catch (e) {
                            resolve({ message: COMPONENT_ERROR, error: e });
                        }
                    } catch (e) {
                        resolve({ message: VIEWS_ERROR, error: e });
                    }
                } catch (e) {
                    resolve({ message: PARSING_ERROR, error: e });
                }
            } catch (e) {
                resolve({ message: MAIN_ERROR, error: e });
            }
        });
    }
